...
for model in ["IIASA GDP", "OECD Env-Growth"]
    for cmip6_scenario in ["SSP1-19", "SSP1-26", "SSP2-45", "SSP3-70 (Baseline)", "SSP3-LowNTCF", "SSP4-34", "SSP4-60", "SSP5-34-OS", "SSP5-85 (Baseline)"]
        ...
        for param in ["ypc_grw", "pop_grw"]
            ...
            ssp_data = DataFrame(load(directory * "/output/SSP Implementation/" * param * "_combined_fund_" * model * "_" * ssp_scenario * ".csv"))
        ...
        for gas in gases
            ...
            # read in data
            ssp_em_data = DataFrame(load(directory * "/output/SSP Implementation/" * gas * "_global_emissions_" * cmip6_scenario * ".csv"))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_global_ypc_to_2100_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_global_ypc_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_global_income_to_2100_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_global_pop_to_2100_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_global_pop_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_co2_emissions_to_2100_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_co2_emissions_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_ch4_emissions_to_2100_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_ch4_emissions_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_n2o_emissions_to_2100_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_n2o_emissions_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_sf6_emissions_to_2100_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_sf6_emissions_" * cmip6_scenario))
        ...
        savefig((directory * "/output/SSP Implementation/" * "fund_global_avg_temp_" * cmip6_scenario))
